...
export const FormGetByPath = (props: FormGetByPathProps) => (
  <Get<FormDto, unknown, FormGetByPathQueryParams, void>
...
export const useFormGetByPath = (props: UseFormGetByPathProps) => useGet<FormDto, unknown, FormGetByPathQueryParams, void>(`/api/services/Shesha/Form/GetByPath`, props);
...
export type FormUpdateMarkupProps = Omit<MutateProps<void, unknown, FormUpdateMarkupQueryParams, FormUpdateMarkupInput, void>, "path" | "verb">;
...
export type UseFormUpdateMarkupProps = Omit<UseMutateProps<void, unknown, FormUpdateMarkupQueryParams, FormUpdateMarkupInput, void>, "path" | "verb">;

export const useFormUpdateMarkup = (props: UseFormUpdateMarkupProps) => useMutate<void, unknown, FormUpdateMarkupQueryParams, FormUpdateMarkupInput, void>("PUT", `/api/services/Shesha/Form/UpdateMarkup`, props);
...
export const useFormGetAll = (props: UseFormGetAllProps) => useGet<FormDtoPagedResultDto, unknown, FormGetAllQueryParams, void>(`/api/services/Shesha/Form/GetAll`, props);
...
export const FormQuery = (props: FormQueryProps) => (
  <Get<void, unknown, FormQueryQueryParams, void>
 ...
 * NOTE: don't use on prod, will be merged with the `Get`endpoint soon
 */
export const useFormQuery = (props: UseFormQueryProps) => useGet<void, unknown, FormQueryQueryParams, void>(`/api/services/Shesha/Form/Query`, props);
...
export const FormQueryAll = (props: FormQueryAllProps) => (
  <Get<void, unknown, FormQueryAllQueryParams, void>
 ...
 * NOTE: don't use on prod, will be merged with the GetAll endpoint soon
 */
export const useFormQueryAll = (props: UseFormQueryAllProps) => useGet<void, unknown, FormQueryAllQueryParams, void>(`/api/services/Shesha/Form/QueryAll`, props);
...
export const FormGet = (props: FormGetProps) => (
  <Get<FormDto, unknown, FormGetQueryParams, void>
...
export const useFormGet = (props: UseFormGetProps) => useGet<FormDto, unknown, FormGetQueryParams, void>(`/api/services/Shesha/Form/Get`, props);
...
export type FormCreateProps = Omit<MutateProps<FormDto, unknown, FormCreateQueryParams, FormDto, void>, "path" | "verb">;
...
export type UseFormCreateProps = Omit<UseMutateProps<FormDto, unknown, FormCreateQueryParams, FormDto, void>, "path" | "verb">;

export const useFormCreate = (props: UseFormCreateProps) => useMutate<FormDto, unknown, FormCreateQueryParams, FormDto, void>("POST", `/api/services/Shesha/Form/Create`, props);
...
export type FormUpdateProps = Omit<MutateProps<FormDto, unknown, FormUpdateQueryParams, FormDto, void>, "path" | "verb">;
...
export type UseFormUpdateProps = Omit<UseMutateProps<FormDto, unknown, FormUpdateQueryParams, FormDto, void>, "path" | "verb">;

export const useFormUpdate = (props: UseFormUpdateProps) => useMutate<FormDto, unknown, FormUpdateQueryParams, FormDto, void>("PUT", `/api/services/Shesha/Form/Update`, props);
...
export type UseFormDeleteProps = Omit<UseMutateProps<void, unknown, FormDeleteQueryParams, void, void>, "path" | "verb">;

export const useFormDelete = (props: UseFormDeleteProps) => useMutate<void, unknown, FormDeleteQueryParams, void, void>("DELETE", `/api/services/Shesha/Form/Delete`, {   ...props });
