...
import { Button, Checkbox, Form, Input, InputNumber, message, Spin, Switch, Tooltip } from 'antd';
import { SmtpSettingsDto, useEmailSenderGetSmtpSettings, useEmailSenderUpdateSmtpSettings } from 'api/emailSender';
...
const EmailSettings = () => {
  ...
  return (
    <Spin spinning={loading} tip="Please wait...">
      <HisMainLayout title="Email" description="">
